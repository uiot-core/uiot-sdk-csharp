...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class MqttClient
    {
        ...
        public MqttClient(string region, string productSN,string deviceSN,string deviceSecret, string caCertFilename) :
#if !(WINDOWS_APP || WINDOWS_PHONE_APP)
            this("mqtt-"+region+".iot.ucloud.cn", MqttSettings.MQTT_BROKER_DEFAULT_SSL_PORT, true, X509Certificate.CreateFromCertFile(caCertFilename), null, MqttSslProtocols.TLSv1_2)
#else
            this("mqtt-"+region+"iot.ucloud.cn", MqttSettings.MQTT_BROKER_DEFAULT_PORT, false, MqttSslProtocols.None)
#endif
        {
        ...
        public byte Connect()
        {
            return this.Connect(this.productSN+"."+this.deviceSN, this.productSN + "|" + this.deviceSN+"|1", deviceSecret, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
        }
